...
import { 
        ...
        FaRegCheckCircle, FaImages, FaHeart, FaAngleLeft,
...
export default function Chat() {
    ...
    const handleLoadMess = () => { 
        setLoadMess(!loadMess);
    }
    ...
    return (
        <>
            ...
            <Header />
            {/* ${Styles["loadMess"]} */}
            <div className={`${Styles["chat__box"]} ${loadMess ? Styles["loadMess"] : ''}`}>
                {/* Box Left */}
                        ...
                        <div className={Styles["chat__box-title"]}>
                            ...
                            <ul className={Styles["chat__create-list"]}>
                                <li className={Styles["chat__create-item"]}>
                                    ...
                                    <span className={Styles["tooltip__create"]}>Tin nhắn mới</span>
                                </li>
                                <li className={Styles["chat__create-item"]}>
                                    <FaUsers className={Styles["chat__create-icon"]} />
                                    <span className={Styles["tooltip__create"]}>Tạo nhóm mới</span>
                                </li>
                            </ul>
                        </div>
                        <form action="" className={Styles["chat__form-group"]}>
                            <input type="text" className={Styles["chat__form-input"]} placeholder="Tìm kiếm trong tin nhắn"/>
                    ...
                    <div className={Styles["chat__box-left-body"]}>
                        <ul className={Styles["chat__nav-list"]}>
                            ...
                            >
                                ...
                                <span className={`${Styles["chat__noti"]} ${Styles["active"]}`}></span>
                            </li>
                            <li 
                        ...
                        <div className={`${Styles["chat__list"]} ${toggleState === 1 ? Styles["active"] : ''}`}>
                            <div className={`${Styles["chat__item"]} ${Styles["mess-select"]}`} onClick={handleLoadMess}>
                                ...
                                <div className={Styles["chat__content"]}>
                                    ...
                                    <div className={Styles["chat__content-bottom"]}>
                                        <p className={Styles["chat__content-mess"]}>Rất vui được gặp bạn Rất vui được gặp bạn</p>
                                        <span className={Styles["chat__noti-count"]}>9+</span>
                                    </div>
                                </div>
                                <FaEllipsisH className={Styles["chat__icon-ellipsis"]}/>
                            </div>
                            <div className={`${Styles["chat__item"]} ${Styles["have-mess"]}`} onClick={handleLoadMess}>
                                <div className={Styles["chat__avatar"]}>
                                    <Image src={Avatar} alt="Avatar"/>
                                </div>
                                <div className={Styles["chat__content"]}>
                            ...
                            <ChatItem handleClick={handleLoadMess}/>
                            <ChatItem handleClick={handleLoadMess}/>
                            <ChatItem handleClick={handleLoadMess}/>
                            <ChatItem handleClick={handleLoadMess}/>
                            <ChatItem handleClick={handleLoadMess}/>
                        ...
                        <div className={`${Styles["chat__list"]} ${toggleState === 2 ? Styles["active"] : ''}`}>
                            <ChatItem handleClick={handleLoadMess}/>
                            <ChatItem handleClick={handleLoadMess}/>
                            <ChatItem handleClick={handleLoadMess}/>
                            <ChatItem handleClick={handleLoadMess}/>
                ...
                <div className={Styles["chat__box-content"]}>
                    <div className={Styles["chat__box-content-heading"]}>
                        <FaAngleLeft className={Styles["chat__box-back-icon"]} onClick={handleLoadMess}/>
                        ...
                        <ul className={Styles["chat__user-action-list"]}>
                            <li className={Styles["chat__user-action-item"]}>
                                ...
                                <span className={Styles["tooltip__create"]}>Bắt đầu gọi thoại</span>
                            </li>
                            <li className={Styles["chat__user-action-item"]}>
                                <FaVideo className={Styles["chat__user-icon"]}/>
                                <span className={Styles["tooltip__create"]}>Bắt đầu gọi video</span>
                            </li>
                            <li className={Styles["chat__user-action-item"]}>
                                <label htmlFor="show-tab-info">
                                    <FaInfoCircle className={Styles["chat__user-icon"]}/>
                                    <span className={Styles["tooltip__create"]}>Thông tin cuộc trò chuyện</span>
                                </label>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div className={Styles["chat__box-chat"]}>
                            <ul className={Styles["chat__sent-list"]}>
                                <li className={Styles["chat__sent-item"]}>
                                    ...
                                    <span className={Styles["chat__sent-tooltip"]}>Đính kèm ảnh</span>
                                </li>
                                <li className={Styles["chat__sent-item"]}>
                                    <FaRegFileAlt className={Styles["chat__sent-icon"]}/>
                                    <span className={Styles["chat__sent-tooltip"]}>Đính kèm tệp</span>
                                </li>
                            </ul>
                ...
                <div className={Styles["chat__box-right"]}>
                    <div className={Styles["chat__box-right-heading"]}>
                        ...
                        <p className={`${Styles["chat__info-time-onl"]} ${Styles["show"]}`}>Đang hoạt động</p>
                    ...
                    <div className={Styles["chat__box-right-body"]}>
                        <div className={Styles["chat__info-option"]}>
                            <h4 className={Styles["chat__info-title"]}>Tùy chỉnh tin nhắn</h4>
                        ...
                        <div className={Styles["chat__info-option"]}>
                            <h4 className={Styles["chat__info-title"]}>Các tùy chỉnh khác</h4>
                            <ul className={Styles["chat__info-option-list"]}>
                                <li className={Styles["chat__info-option-item"]}>
                        ...
                        <div className={Styles["chat__info-option"]}>
                            <h4 className={Styles["chat__info-title"]}>Quyền riêng tư - hỗ trợ</h4>
                            <ul className={Styles["chat__info-option-list"]}>
                                <li className={Styles["chat__info-option-item"]}>
...
export function ChatItem({handleClick}) {
    return (
        ...
        <div className={`${Styles["chat__item"]}`} onClick={handleClick}>
            <div className={Styles["chat__avatar"]}>
                <Image src={Avatar} alt="Avatar"/>
            </div>
            <div className={Styles["chat__content"]}>
