...
export default function ChatBox({ isShowChatBox }) {
    ...
    return (
        <>
            <div className={`${Styles["chatbox"]} ${showChatBox === isShowChatBox ? Styles["showBoxChat"] : ''}`}>
                        ...
                        <li className={Styles["chatbox-action-item"]}>
                            <FaTimes className={Styles["chatbox-action-icon"]}
                                onClick={() => {
                                    ...
                                    let noti = window.document.querySelector('[class^="ChatBox_chatnoti-item"]');
